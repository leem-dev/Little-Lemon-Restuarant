    ...
    return (
        <div className="specialSection">
            <div className="specials-top">
                ...
                <button type="button" className="menu-btn btn">Online menu</button>
            </div>
            ...
            <div className="specials-bottom">
                <div className="specials-box">
                    ...
                    <div className="specials-inner-box">
                        ...
                        <div className="specials-info">
                            <p className="specials-info-text">The famous greek salad of crispy lettuce, peppers, olives and our Chicago style feta cheese, garnished with crunchy garlic and rosemary croutons.</p>
                        </div>
                ...
                <div className="specials-box">
                    ...
                    <div className="specials-inner-box">
                        ...
                        <div className="specials-info">
                            <p className="specials-info-text">Our Bruschetta is made from grilled bread that has been smeared with garlic and seasoned with salt and olive oil.</p>
                        </div>
                        <div className="specials-delivery">
                            <a href="_blank">Order a delivery</a>
                            <img src={Delivery} alt="delivery" style={delivery} />
                ...
                <div className="specials-box">
                    ...
                    <div className="specials-inner-box">
                        ...
                        <div className="specials-info">
                            <p className="specials-info-text">This comes straight fromm grandma's recipe book, every last ingredient has been sourced and is as authentic as can be imagined.</p>
                        </div>
                        <div className="specials-delivery">
                            <a href="_blank">Order a delivery</a>
                            <img src={Delivery} alt="delivery" style={delivery}/>
